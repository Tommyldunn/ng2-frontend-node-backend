!function(e, n, t) {
  ...
  function r() {
    ...
    for (var f in C)
      ...
      for (r = s(n.fn, "function")
          ? n.fn()
          : n.fn, i = 0; i < e.length; i++)
          o = e[i],
          a = o.split("."),
          1 === a.length
            ? Modernizr[a[0]] = r
            : (!Modernizr[a[0]] || Modernizr[a[0]]instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = r),
          y.push((r
            ? ""
            : "no-") + a.join("-"))
        }
  ...
  function i(e) {
    ...
    Modernizr._config.enableClasses && (n += " " + t + e.join(" " + t), x
      ? S.className.baseVal = n
      : S.className = n)
  }
  function o() {
  ...
  return i = o("style"),
    ...
    p.id = d,
    c.fake && (c.style.background = "", c.style.overflow = "hidden", u = S.style.overflow, S.style.overflow = "hidden", S.appendChild(c)),
    f = t(p, e),
    c.fake
  ...
  function v(e, n, t, r, i) {
    var o = e.charAt(0).toUpperCase() + e.slice(1),
      a = (e + " " + z.join(o + " ") + o).split(" ");
    return s(n, "string") || s(n, "undefined")
      ? h(a, n, r, i)
      : (a = (e + " " + E.join(o + " ") + o).split(" "), p(a, n, t))
  }
  function g(e, n, s) {
    return v(e, t, t, n, s)
  }
